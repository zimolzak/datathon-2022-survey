...
data %>%
  rename(
    ...
    department = pdrc,
    years = yabcm,
    prior_datathon = phdaai,
    prior_ehr = qipr,
    team_size = pot,
    team_prior_work = wwdtm,
    role_clinical = role___1,
    role_lead = role___2,
    role_reviewer = role___3,
    role_datasci = role___4,
    role_stats = role___5,
    role_datawarehouse = role___6,
    role_datamgr = role___7,
    role_learner = role___8,
    role_other = role___9,
    pre_know_avail = kadapr,
    pre_know_use = kadupr,
    pre_know_limit = kadlpr,
    person_hours = hrdw,
    percent_with_it = prodw,
    difficult_obtain = doifda,
    difficult_working = dwwda,
    post_know_avail = kadaf,
    post_know_use = kaduf,
    post_know_limit = kadlf,
    succeed_completed = cpbeoda,
    succeed_answered = sacq,
    succeed_collaborated_outside = cwiod,
    succeed_collaborated_people = cwni,
    attitude_future_study = pcfsuda,
    success_abstract = tpriasa,
    success_paper = tdprip,
    attitude_valuable = pidaav,
    attitude_future_datathon = wpfda
  ) %>%
  select (
    academic_rank,
    department,
